	...
	render: function() {
		var currentForm = (
			React.createElement("div", null, 
				React.createElement(NavTop, {callbackFn: this.changeTab}), 
...
},{"./components/NavTop.jsx":2,"./forms/AboutForm.jsx":4,"./forms/OrderForm.jsx":5,"./forms/OrderInForm.jsx":6,"./forms/OrderOutForm.jsx":7,"./forms/ProductForm.jsx":8,"react":164}],2:[function(require,module,exports){
var React = require('react');
...
},{"./../components/OrderOutItemRow.jsx":3,"react":164}],8:[function(require,module,exports){
var React = require('react');
	...
	render: function() {
		var formReturn = (
			React.createElement("div", {className: "form-group col-xs-12 col-sm-6"}, 
							...
							this.state.productListData.map(function(product, index) {
								return (
									React.createElement("tr", {key: 'tr' + index}, 
										...
										React.createElement("td", null, React.createElement("a", {href: "#", onClick: this.showProductInfo.bind(null, index)}, product.productname)), 
										React.createElement("td", null, product.price), 
										React.createElement("td", null, product.stock), 
										React.createElement("td", null, React.createElement("a", {href: "#", onClick: this.deleteProduct.bind(null, product._id)}, "delete"))
									)
								)
							}, this)
				...
				React.createElement("div", {className: "row"}, 
					React.createElement("div", {className: "col-sm-3"}, 
						React.createElement("select", {className: "form-control", onChange: this.changeProductsPerPage}, 
